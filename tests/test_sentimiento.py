...
class TestProveedor:
    ...
    def test_ollama_model_tiene_valor_defecto(self) -> None:
        from src.sentimiento.proveedor import OLLAMA_MODEL

        assert OLLAMA_MODEL == "qwen2.5:3b"

    def test_generar_respuesta_sin_modelo(self) -> None:
        from src.sentimiento.proveedor import generar_respuesta

        with patch("src.sentimiento.proveedor._generar_ollama") as mock:
    ...
    def test_generar_respuesta_con_modelo_explicito(self) -> None:
        ...
        with patch("src.sentimiento.proveedor._generar_ollama") as mock:
            mock.return_value = "respuesta"
            resultado = generar_respuesta("prompt", "texto", modelo="llama3")
...
class TestNiveles:
    ...
    def test_parsear_json_respuesta_vacia(self) -> None:
        from src.sentimiento.niveles import _parsear_json_respuesta
    ...
    def test_validar_texto_rechaza_vacio(self) -> None:
        from src.sentimiento.niveles import _validar_texto
    ...
    def test_basico_con_mock_proveedor(self) -> None:
        from src.sentimiento.niveles import analizar_sentimiento_basico

        with patch("src.sentimiento.niveles._crear_respuesta") as mock:
    ...
    def test_intermedio_con_mock(self) -> None:
        from src.sentimiento.niveles import analizar_sentimiento_intermedio
    ...
    def test_avanzado_con_mock(self) -> None:
        from src.sentimiento.niveles import analizar_sentimiento_avanzado
